    ...
    <MovieItemCont>
      ...
      <MovieItemBox>
        ...
        <section css={infoSectionStyle}>
          <p>
            <LighterText>runtime</LighterText> {movie.runtime} min
          </p>
          <p>
            <LighterText>genres</LighterText> {movie.genre.join(", ")}
          </p>
          {/* <p><LighterText>reżyseria</LighterText> {movie.directior}</p> */}
          <p css={sectionSeparator}>
            <LighterText>production</LighterText> {movie.countries.join(", ")}
          </p>
          <p>{movie.description}</p>
        </section>
      </MovieItemBox>
      <p>
        <LighterText>Screening</LighterText>
          ...
          if (isActive) {
            return (
              <Link
                ...
                key={index}
              >
                <CustomLink active={isActive} onClick={() => handleClick(item)}>
                  {item.time}
                </CustomLink>
              </Link>
            );
            ...
            return (
              <CustomLink active={isActive} key={index}>
                {item.time}
              </CustomLink>
            );
          }
